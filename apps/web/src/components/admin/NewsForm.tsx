  ...
  if (isFetching) {
    return (
      <div className="flex items-center justify-center py-20">
        ...
        <span className="ml-3 text-text-muted">Loading article data...</span>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center gap-3 cursor-pointer pt-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-text-base">Featured Article</p>
                  <p className="text-xs text-text-muted">Pin this article to the top of the blog page.</p>
                </div>
              </label>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between pt-2">
          <button type="button" onClick={() => router.push('/admin/dashboard/news')} className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-text-muted bg-white border border-border rounded-xl hover:bg-surface-mint hover:text-brand-dark transition cursor-pointer">
